...
{{--                                fill="#EE1D48" />--}}
{{--                        </svg>--}}
{{--                        <h3> {{ __('Provide your location') }} </h3>--}}
...
{{--                                fill="#EE1D48" />--}}
{{--                        </svg>--}}
{{--                        <h3> {{ __('Choose your restaurant & food') }} </h3>--}}
{{--                        <p> {{ __('Browse through many restaurant and cuisine') }}</p>--}}
{{--                    </div>--}}
{{--                    <div class="swiper-slide">--}}
{{--                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"--}}
{{--                            xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                                fill="#EE1D48" />--}}
{{--                        </svg>--}}
{{--                        <h3> {{ __('Pay & get your food') }} </h3>--}}
{{--                        <p> {{ __('Pay using various payment methods') }}</p>--}}
{{--                    </div>--}}
