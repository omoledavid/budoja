                        ...
                        <ul class="order-price-list">
                            @if ($order->discount->amount > 0 && Schema::hasColumn('coupons', 'slug'))
                                <li>
                                    ...
                                    <span
                                        class="pe-xxl-5 pe-xl-4 pe-lg-1 pe-md-2">{{ currencyFormat($order->discount->amount) }}</span>
                                </li>
                            @endif

                            <li><span>{{ __('frontend.subtotal') }}</span>
                                <span
                                    class="pe-xxl-5 pe-xl-4 pe-lg-1 pe-md-2">{{ currencyFormat($order->sub_total) }}</span>
                            </li>

                            <li><span>{{ __('frontend.delivery_charge') }}</span>
                                <span
                                    class="pe-xxl-5 pe-xl-4 pe-lg-1 pe-md-2">{{ currencyFormat($order->delivery_charge) }}</span>
                            </li>
                            <li>
